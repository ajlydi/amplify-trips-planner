...
class EditTripPage extends ConsumerStatefulWidget {
  const EditTripPage({required this.trip, super.key});
...
class EditTripPageState extends ConsumerState<EditTripPage> {
  ...
  void initState() {
    ...
    endDateController.text = widget.trip.endDate.getDateTime().format(
      'yyyy-MM-dd',
    );
              ...
              children: [
                ...
                BottomSheetTextFormField(
                  ...
                  onTap: () async {
                    ...
                    if (pickedDate != null) {
                      startDateController.text = pickedDate.format(
                        'yyyy-MM-dd',
                      );
                    }
                  },
                ...
                BottomSheetTextFormField(
                  ...
                  onTap: () async {
                    if (startDateController.text.isNotEmpty) {
                      ...
                      if (pickedDate != null) {
                        endDateController.text = pickedDate.format(
                          'yyyy-MM-dd',
                        );
                      }
                    }
