...
class ActivityListView extends ConsumerWidget {
  const ActivityListView({required this.activity, super.key});
        ...
        return ListView(
          children: [
            ...
            Card(
              child: ListTile(
                title: Text(
                  value.activityDate.getDateTime().format(
                    'EE MMMM dd',
                  ),
                  style: Theme.of(context).textTheme.titleLarge,
                ),
