...
class ActivityPage extends ConsumerWidget {
  const ActivityPage({required this.activityId, super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final activityValue = ref.watch(
      activityControllerProvider(activityId),
    );
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: ActivityPageAppBarIcon(activity: activityValue),
        backgroundColor: const Color(constants.primaryColorDark),
      ),
      body: ActivityListView(activity: activityValue),
    );
  }
}
