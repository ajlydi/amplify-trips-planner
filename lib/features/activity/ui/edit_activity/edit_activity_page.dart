...
class EditActivityPageState extends ConsumerState<EditActivityPage> {
  ...
  void initState() {
    ...
    activityDateController.text = widget.activity.activityDate
        .getDateTime()
        .format('yyyy-MM-dd');

    activityTime = TimeOfDay.fromDateTime(
      widget.activity.activityTime!.getDateTime(),
    );
    activityTimeController.text = widget.activity.activityTime!
        .getDateTime()
        .format('hh:mm a');
              ...
              children: [
                ...
                BottomSheetTextFormField(
                  ...
                  onTap: () async {
                    ...
                    if (pickedDate != null) {
                      activityDateController.text = pickedDate.format(
                        'yyyy-MM-dd',
                      );
                    } else {}
                  },
                  ...
                  onPressed: () async {
                    ...
                    if (currentState.validate()) {
                      ...
                      final updatedActivity = widget.activity
                          .copyWith(
                            category: ActivityCategory.values.byName(
                              activityCategoryController.text,
                            ),
